...
- packages for working with specific API, e.g. [rnassqs](https://docs.ropensci.org/rnassqs/) for accessing data from NASS '[Quick Stats]()' or [spotifyr](https://www.rcharlie.com/spotifyr/) for accessing Spotify's API
