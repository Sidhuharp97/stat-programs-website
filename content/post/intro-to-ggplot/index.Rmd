...
knitr::include_graphics(c("curve_fitting.png"))
```

*(It won't take that long to read this)*
...
The package 'viridis' also has some nice color palettes that are widely used and accepted. Information about color palettes have been [comprehensively explored by Emil Hvitfeldt](https://github.com/EmilHvitfeldt/r-color-palettes/blob/master/README.md) and worth a read. 
...
```
ggsave("PNW_hay_production.png", dpi = 400)
```
...
vignette("ggplot2")
```
**(there are innumerable ggplot tutorials on the interwebs)**

  * [R Graphics Cookbook Online Tutorial](http://www.cookbook-r.com/Graphs)
  * [R Graphics Cookbook](https://www.amazon.com/Graphics-Cookbook-Practical-Recipes-Visualizing-ebook/dp/B07JPL9K64/ref=sr_1_3?crid=2MKCW89GC5VP6&keywords=r+graphics+cookbook&qid=1554928039&s=books&sprefix=R+gra%2Cstripbooks%2C218&sr=1-3) ($$). This book is written by Winston Change, the main author of the ggplot2 package. 
...
Plot of shots made by NBA Player Steph Curry:  
```{r eval=FALSE, include=FALSE}
