...
vignette("ggplot2")
```
  * There are innumerable ggplot tutorials on the interwebs, such as [here](https://ggplot2tutor.com/), [here](https://uc-r.github.io/ggplot_intro) and [here](https://r-statistics.co/Complete-Ggplot2-Tutorial-Part2-Customizing-Theme-With-R-Code.html), among others

  * [R Graphics Cookbook Online Tutorial](http://www.cookbook-r.com/Graphs)
  * [R Graphics Cookbook](https://www.amazon.com/Graphics-Cookbook-Practical-Recipes-Visualizing-ebook/dp/B07JPL9K64/ref=sr_1_3?crid=2MKCW89GC5VP6&keywords=r+graphics+cookbook&qid=1554928039&s=books&sprefix=R+gra%2Cstripbooks%2C218&sr=1-3) ($$). This book is written by Winston Chang, the main author of the ggplot2 package. 
